...
const string configUrl = "https://openplanet.dev/plugin/freecam-showcp/config/version-compat";
...
void OverrideGameSafetyCheck_Settings() {
    ...
    if (!GameVersionSafe && UI::Button("Disable safety features and run anyway")) {
        OverrideGameSafetyCheck_FreecamShowCP();
    }
}

void OverrideGameSafetyCheck_FreecamShowCP(bool safe = true) {
    GameVersionSafe = safe;
}

bool IsGameVersionSafe_FreecamShowCP() {
